...
function draw() {
  ...
  for (let i = 0; i < detections.length; i++) {
    ...
    if (object.label === 'bottle') {
      text('bisleri', object.x + 50, object.y + 300);
      image(bisleriImage, -55, 440, bisleriImage.width / 3.4, bisleriImage.height / 3.4);
    } else if (object.label === 'banana') {
      text('banana', object.x + 50, object.y + 215);
      image(bananaImage, -55, 440, bananaImage.width / 3.4, bananaImage.height / 3.4);
    } else if (object.label === 'orange') {
      text('orange', object.x + 50, object.y + 215);
      image(orangeImage, -55, 440, orangeImage.width / 3.4, orangeImage.height / 3.4);
    }
  }
